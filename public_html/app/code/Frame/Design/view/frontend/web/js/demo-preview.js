  ...
  $.danidemo = $.extend( {}, {
    ...
    addFile: function(id, i, file){
		var template = '<div id="demo-file' + i + '">' +
		                   ...
		                   file.name + ' <span class="demo-file-size">(' + $.danidemo.humanizeSize(file.size) + ')</span><br />Status: <span class="demo-file-status">Waiting to upload</span>'+
	...
	setSucessImageUpload: function(i){
		$('#countimg').html(i);
	},
	setMessageImageUpload: function(type,msg){
		$('#infomsg').html(msg);
	},
