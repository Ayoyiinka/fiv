<?php
namespace Pmclain\Stripe\Block\Info;

/**
 * Interceptor class for @see \Pmclain\Stripe\Block\Info
 */
class Interceptor extends \Pmclain\Stripe\Block\Info implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getInfo');
        if (!$pluginInfo) {
            return parent::getInfo();
        } else {
            return $this->___callPlugins('getInfo', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getChildPdfAsArray');
        if (!$pluginInfo) {
            return parent::getChildPdfAsArray();
        } else {
            return $this->___callPlugins('getChildPdfAsArray', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSpecificInformation');
        if (!$pluginInfo) {
            return parent::getSpecificInformation();
        } else {
            return $this->___callPlugins('getSpecificInformation', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getValueAsArray');
        if (!$pluginInfo) {
            return parent::getValueAsArray($value, $escapeHtml);
        } else {
            return $this->___callPlugins('getValueAsArray', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIsSecureMode');
        if (!$pluginInfo) {
            return parent::getIsSecureMode();
        } else {
            return $this->___callPlugins('getIsSecureMode', func_get_args(), $pluginInfo);
        }
    }
